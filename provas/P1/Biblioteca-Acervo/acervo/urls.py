...
urlpatterns = [
    ...
    path("solicitar/<int:livro_id>/",views.solicitar_livro,name="solicitar_livro",),
    
    path("reservas/<int:livro_id>/", views.fila_reservas, name="fila_reservas"),
    ...
    path("exemplar/novo/", views.cadastrar_exemplar, name="cadastrar_exemplar"),
